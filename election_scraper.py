...
def main():
    ...
    parser.add_argument("url_volebnich_vysledku",
                        ...
                        default="https://www.volby.cz/pls/ps2017nss/ps32?xjazyk=CZ&xkraj=2&xnumnuts=2109")

    # Přidání druhého povinného argumentu pro název výstupního souboru
    parser.add_argument("output_file", help="Název výstupního souboru", default="vysledky_pvychod.csv")
    ...
    if not is_valid_url(args.url_volebnich_vysledku):
        print("První argument musí být platná URL!")
        sys.exit(1)

    if not is_valid_filename(args.output_file):
